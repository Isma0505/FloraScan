...
export const translations = {
  id: {
    ...
    result: {
      ...
      weakPassword: "Kata sandi terlalu lemah. Gunakan minimal 6 karakter dengan variasi huruf, angka, dan simbol",
      name: "Nama",
      loginTitle: "Masuk ke FloraScan",
      registerTitle: "Buat Akun FloraScan",
      loginSuccess: "Berhasil masuk",
      registerSuccess: "Akun berhasil dibuat",
      authError: "Email atau kata sandi tidak valid",
      ...
      profileError: "Profil gagal disimpan. Silakan masuk kembali.",
  ...
  en: {
    ...
    result: {
      ...
      weakPassword: "Password is too weak. Use at least 6 characters with a mix of letters, numbers, and symbols",
      name: "Name",
      loginTitle: "Log in to FloraScan",
      registerTitle: "Create a FloraScan Account",
      ...
      profileError: "The profile could not be saved. Please log in again.",
